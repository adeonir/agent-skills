...
description: >-
  ...
  tracking decisions across sessions, or capturing baselines of existing code.
  ...
  "plan this feature", "show status", "capture baseline", "document module",
...
└── baselines/            # Behavioral baselines (baseline-capture output)
    └── {area-name}.md
```
