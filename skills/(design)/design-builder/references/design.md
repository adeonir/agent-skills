...
2. Check for existing context in `.artifacts/`:
   - `docs/prd.md` -- read and extract purpose, audience, tone, features (generated by docs-writer skill)
   - `docs/brief.md` -- read and extract purpose, audience, tone (generated by docs-writer skill)
