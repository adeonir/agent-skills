...
Leave narrative sections (`## 1. Overview`, `## 8. Do's and Don'ts`, `## 11. Agent Prompt Guide`, `## 10. Responsive Behavior`) untouched. Flag them as potentially stale relative to the new tokens; recommend re-running [design.md](design.md) if narrative refresh is wanted.
