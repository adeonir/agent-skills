...
|-----|----------|------|---------------|
| **Brief** | Execs, stakeholders, sponsors | One-page narrative: What/Why/Who, must-have scope, success metrics, top risks | Product spec depth, technical content, alternatives |
...
- Brief is the 1-page narrative summary of the PRD — same discovery feeds both, never written standalone.
