...
- **Typography** — one well-tuned sans often carries headings, labels, body, and data; fixed rem scale (not fluid); tighter ratio (1.125–1.2). System stacks are acceptable.
