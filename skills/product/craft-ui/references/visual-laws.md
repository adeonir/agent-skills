...
Universal principles for how the eye reads a surface — *why* a composition works. The recipes that apply them live in the craft dimensions (color/typography/layout/motion/interaction/responsive).
