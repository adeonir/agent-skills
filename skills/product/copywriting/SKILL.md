...
description: >-
  ...
  propositions, landing-page or CTA copy; extracting or structuring
  content; capturing copy from a screenshot; or preparing copy.yaml for
  design work. Not for visual identity or design tokens, page layout or
  screen flow, or standalone social bios.
---
...
Loaded on demand by the write workflow:
