...
- **Validate (UAT) is on-demand** -- user requests it when they want to manually test, any scope; **required before `done` for user-facing features**; may revert any `[x]` if user reproves
