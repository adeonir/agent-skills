...
- [acceptance-criteria.md](references/acceptance-criteria.md) — the Gherkin form, `AC-N.M` identity, reshape vs author, `Serves` and `Satisfies`, `[seed-gap]`, case convention, calibration against the goal
