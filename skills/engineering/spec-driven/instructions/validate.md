...
1. **Confirm the gate** — `spec.md user-facing: true` and audit status PASS. Otherwise stop; there is nothing to validate. Set `.artifacts/STATE.md ## Progress` `Phase` to `validate`.
