...
---
name: <slug>
sources:                           # the seed + every reference it carries that the spec consumed
...
## References          <!-- conditional: only when the domain lookup ran -->
- [title] — [url]
````
