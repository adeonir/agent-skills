...
Only when the user explicitly asks to archive a feature. Optional and manual — never automatic or suggested. The feature may be in any artifact state. Archiving changes the folder only; it does not change artifact states or `.artifacts/STATE.md`.
...
3. **Keep** every artifact and `.artifacts/STATE.md` unchanged.
