...
What to cut — the word lists and the pattern catalog that both modes name findings from.

## When to Use

Read before editing a draft and before reporting a detect verdict. Edit mode cuts what this file names; detect mode quotes it back with a fix.

## Words to Cut

A word from these lists stays when the draft quotes it as an example of itself.
...
**Em dashes.** Not a default rhythm crutch. In short copy, use none. In longer drafts, 1-2 are fine when they clearly beat commas, periods, or parentheses. Remove clusters and decorative dashes.
